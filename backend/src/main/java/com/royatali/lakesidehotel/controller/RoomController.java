...
import com.royatali.lakesidehotel.exception.PhotoRetrievalException;
...
import com.royatali.lakesidehotel.service.BookingService;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> addNewRoom(
        ...
        return  ResponseEntity.created(new URI("/rooms/"+savedRoom.getId())).body(response);
