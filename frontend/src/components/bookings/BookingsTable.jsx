...
const BookingsTable = ({ bookingInfo, handleBookingCancellation }) => {
  ...
  const handleOpenDeleteBookingModal = (booking) => {
    ...
    <section className="p-4">
            ...
            <tr key={booking.id}>
              ...
              <td>
                <button
                  ...
                  onClick={() => handleOpenDeleteBookingModal(booking.id)}
                >
                  Cancel
                </button>
              </td>
      ...
      {openDeleteBookingModal && (
        <DeleteBookingModal
          ...
          setOpen={setOpenDeleteBookingModal}
          handleDelete={handleBookingCancellation}
